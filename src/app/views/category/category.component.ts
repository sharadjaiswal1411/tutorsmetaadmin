...
category:any
  constructor(private httpClient:HttpClient, public router: Router,private activerouter:ActivatedRoute,private categoryService:CategoryService){
...
if(this.search_text)
this.current_page=1;
this.categoryService.getSubjectData(this.current_page,this.per_page,this.search_text,this.status).subscribe(data=>{
...
//   this.categoryService.getclassStatus(this.current_page,this.per_page,this.search_text,this.status)
//.subscribe(data=>{
//     console.log("dataaaaaa",data.result.data.results);
//     this.subjectData=data.result.data.results;
//    this.meta = data.result.data.meta;
...
// getSubject(){
  ...
  delete(id){
//console.log(id);
    this.categoryService.deleteSubjectData(id).subscribe(data=>{
  ...
  //     this.form.reset();
  //     let subjectdata=this.categoryService.viewSubjectData(this.form.firstName.value).subscribe(data=>{
