...
category:any
  constructor(private httpClient:HttpClient, public router: Router,private activerouter:ActivatedRoute,private classService:ClassService){
...
if(this.search_text)
this.current_page=1;
this.classService.getSubjectData(this.current_page,this.per_page,this.search_text,this.status,this.subcategory,this.category).subscribe(data=>{
