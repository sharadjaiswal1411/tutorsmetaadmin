...
@Component({
  ...
  styles: ['.pager li.btn:active { box-shadow: none; }.h5{   font-size: 12px;}'],
...
category:any
  constructor(private httpClient:HttpClient, public router: Router,private activerouter:ActivatedRoute,private services:TeacherService){
...
if(this.search_text)
this.current_page=1;
this.services.getSubjectData(this.current_page,this.per_page,this.search_text,this.status,this.subcategory,this.category).subscribe(data=>{
...
//   this.services.getclassStatus(this.current_page,this.per_page,this.search_text,this.status)
//.subscribe(data=>{
//     console.log("dataaaaaa",data.result.data.results);
//     this.subjectData=data.result.data.results;
//    this.meta = data.result.data.meta;
...
// getSubject(){
  ...
  // }
  getdata1(){
    this.services.getCategoryData().subscribe(data=>{
        console.log("dataaaaaa",data.result.data.results);
    ...
    getdata2(){
      this.services.getSubCategoryData().subscribe(data=>{
          console.log("dataaaaaa",data.result.data.results);
  ...
  delete(id){
//console.log(id);
    this.services.deleteSubjectData(id).subscribe(data=>{
  ...
  //     this.form.reset();
  //     let subjectdata=this.services.viewSubjectData(this.form.firstName.value).subscribe(data=>{
