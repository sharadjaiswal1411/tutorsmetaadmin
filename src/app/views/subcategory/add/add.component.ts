...
export class AddComponent implements OnInit {
  ...
  constructor(private http: HttpClient, public router: Router,private classService:SubcategoryService) { }
...
submit(name:string,status:string,category:string): Observable<any> {
  ...
  //console.log(headers);
    ...
    this.setSubject();
    return this.http.post<any>(environment.API_URL+'subcategory',{name:name,status:status,categoryId:category},{headers});
}
